...
public class BrobIntTester {
   ...
   public static void main( String[] args ) {
      ...
      try {
         System.out.println( "      expecting: " + BrobInt.Cero.toString() + "\n" +
                             "        and got: " + g5.toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "      expecting: " + BrobInt.Uno.toString() + "\n" +
                             "        and got: " + g6.toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "      expecting: " + BrobInt.Deis.toString() + "\n" +
                             "        and got: " + g7.toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
...
//         g10 = BrobInt.valueOf( long03 );
      ...
      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + ": Adding -999 and -9999: " );
         System.out.println( "      expecting: -10998\n" +
                             "        and got: " + new BrobInt( "-999" ).add( new BrobInt( "-9999" ) ).toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.getMessage() ); }
      ...
      try {
         System.out.println( "\n    Test " + df.format( testNumber++ ) + ": Subtracting -999 take away -9999: " );
         System.out.println( "      expecting: 9000\n" +
                             "        and got: " + new BrobInt( "-999" ).subtract( new BrobInt( "-9999" ) ).toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.getMessage() ); }
      ...
      try {
         System.out.println( "      expecting: 248498500\n" +
                             "        and got: " + new BrobInt("82832833").multiply( new BrobInt( "3" ) ).add( BrobInt.Uno ).toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.toString() ); }
...
//      try {
//         System.out.println( "      expecting: true\n" +
//                             "        and got: " + BrobInt.Deis.allZeroDetect( new BrobInt( "0000000" ) ) );
//      }
//      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.toString() ); }
      ...
      try {
         System.out.println( "      expecting: 26\n" +
                             "        and got: " + fiftytwo.divide( BrobInt.Dos ).toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.toString() ); }
      ...
      try {
         System.out.println( "      expecting: 5000\n" +
                             "        and got: " + tenK.divide( BrobInt.Dos ).toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " + e.toString() ); }
